...
<head>
    ...
    <title>FUTUREINTERSTELLAR</title>
                ...
                <div class="header-center">
                    <nav id="sideNav" class="mainmenu-nav navbar-example2 d-none d-xl-block onepagenav">
                        ...
                        <ul class="primary-menu nav nav-pills">
                            ...
                            <li class="nav-item"><a class="nav-link" href="#wedo">We Do</a></li>
        ...
        <div class="inner">
            ...
            <div class="content">
                <ul class="primary-menu nav nav-pills onepagenav">
                    ...
                    <li class="nav-item"><a class="nav-link smoth-animation" href="#wedo">We Do</a></li>
                    <li class="nav-item"><a class="nav-link smoth-animation" href="#portfolio">Our Works</a></li>
                    <!-- <li class="nav-item"><a class="nav-link smoth-animation" href="#training">training</a></li> -->
                ...
                <div class="container">
                    <div class="row row--30 align-items-center">
                        <div class="order-2 order-lg-1 col-lg-7 mt_md--50 mt_sm--50 mt_lg--30">
                            <div class="content">
                                <div class="inner">
                                    <span class="subtitle">Either you run the day or the day runs you</span>
                                    <h1 class="title">Stay hungry, <span>stay foolish</span><br>
                                        ...
                                        <span class="cd-words-wrapper">
                                                    <b class="is-visible">WAY TO FUTURE</b>
                                                    <b class="is-hidden">DEAR FRIENDS</b>
                                                    <b class="is-hidden">DEAR ENTREPRENEURS</b>
                                                    <b class="is-hidden">DEAR STUDENTS</b>
                                                    <b class="is-hidden">WELCOME TO OUR WORLD</b>
                                                </span>
                                        </span>
                                        <!-- type headline end -->
                                        </span>
                                    ...
                                    <div>
                                        <p class="description">“Take up one idea. Make that one idea your life; dream of it; think of it; live on that idea. Let the brain, the body, muscles, nerves, every part of your body be full of that idea, and just leave every other idea alone. This is the way to success, and this is the way great spiritual giants are produced.” </p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6 col-xl-6 col-md-6 col-sm-6 col-12">
                                        <div class="social-share-inner-left">
                                            ...
                                            <ul class="social-share d-flex liststyle">
                                                ...
                                                <li class="instagram"><a target="_blank" href="https://instagram.com/futureinterstellar?utm_source=qr&igshid=MThlNWY1MzQwNA"><i data-feather="instagram"></i></a>
                                                </li>
                        ...
                        <div class="order-1 order-lg-2 col-lg-5">
                            <div class="thumbnail">
                                <div class="inner">
                                    <img src="assets/images/slider/robot.png" alt="Personal Portfolio Images">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="rn-service">
                            <div class="inner">
                                ...
                                <div class="content">
                                    ...
                                    <p class="description"> 
                                        E-commerce software is a stand-alone program or software suite that enables you to sell your products and services online. It allows you to streamline all of your processes from inventory to sales through the backend and makes it easy for a customer to buy from the front end, which is your website.</p>
                    ...
                    <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="100" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-sm-12 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div class="rn-service">
                            <div class="inner">
                                ...
                                <div class="content">
                                    <h4 class="title"><a href="#training">WEBSITES</a></h4>
                                    <p class="description">Static , Dynamic websites based on requirement and customization like Personal and Blogs: Individual interests, journals, and opinions.
                                        Business and E-commerce: Company profiles, products, and online sales,
                                        Education and Media: Learning resources, news, and social connections.</p>
                                    <a class="read-more-button" href="#training"><i class="feather-arrow-right"></i></a>
                                </div>
                            </div>
                            <a class="over-link" href="#training"></a>
                        </div>
                    </div>
                    <!-- End SIngle Service -->
                    <!-- Start Single Service -->
                        ...
                        <div class="rn-service">
                            <div class="inner">
                                ...
                                <div class="content">
                                    ...
                                    <p class="description"> News, Books, Navigation, Business, Education, Photos & Video, Finance, Productivity, Lifestyle, Social Networking, and more</p>
                                    <a class="read-more-button" href="#"><i class="feather-arrow-right"></i></a>
                                </div>
                            </div>
                            <a class="over-link" href="#"></a>
                    ...
                    <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="300" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-sm-12 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div class="rn-service">
                            <div class="inner">
                                ...
                                <div class="content">
                                    <h4 class="title"><a href="#">AWS HOSTING</a></h4>
                                    <p class="description">Amazon Web Services offers cloud web hosting solutions that provide businesses, non-profits, and governmental organizations with low-cost ways to deliver their websites and web applications.</p>
                                    <a class="read-more-button" href="#"><i class="feather-arrow-right"></i></a>
                                </div>
                            </div>
                            <a class="over-link" href="#"></a>
                    ...
                    <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="500" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-sm-12 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div class="rn-service">
                            <div class="inner">
                                ...
                                <div class="content">
                                    <h4 class="title"><a href="#">DOMAIN AND HOSTING MANAGEMENT</a></h4>
                                    <p class="description"> Domain is the address, which allows a visitor to easily find your website online, while hosting is where the website files are stored. In order to have a functioning website, you need both – a domain and hosting space.</p>
                                    <a class="read-more-button" href="#"><i class="feather-arrow-right"></i></a>
                                </div>
                            </div>
                            <a class="over-link" href="#"></a>
                     ...
                     <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="500" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-sm-12 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div class="rn-service">
                            <div class="inner">
                                ...
                                <div class="content">
                                    <h4 class="title"><a href="#">REST API'S</a></h4>
                                    <p class="description"> 
                                        A REST API (also known as RESTful API) is an application programming interface (API or web API) that conforms to the constraints of REST architectural style and allows for interaction with RESTful web services</p>
                                    <a class="read-more-button" href="#"><i class="feather-arrow-right"></i></a>
                                </div>
                            </div>
                            <a class="over-link" href="#"></a>
                     ...
                     <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="500" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-sm-12 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div class="rn-service">
                            <div class="inner">
                                ...
                                <div class="content">
                                    <h4 class="title"><a href="#">APP BACKEND</a></h4>
                                    <p class="description"> 
                                        A backend for a mobile & web application is the part of the app that runs on a server, rather than on the device itself. The backend provides the functionalities that the app needs to store and manage data, authenticate users, process and analyze data, and communicate with other systems or services</p>
                                    <a class="read-more-button" href="#"><i class="feather-arrow-right"></i></a>
                                </div>
                            </div>
                            <a class="over-link" href="#"></a>
                     ...
                     <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="500" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-sm-12 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div class="rn-service">
                            <div class="inner">
                                ...
                                <div class="content">
                                    <h4 class="title"><a href="#">ADMIN PANELS</a></h4>
                                    <p class="description"> 
                                        An admin panel or a control panel is a system that enables administrators and other website workers to conduct various tasks like monitoring, maintaining, and controlling certain business processes. An admin dashboard is one of the core components of a control panel.</p>
                                    <a class="read-more-button" href="#"><i class="feather-arrow-right"></i></a>
                                </div>
                            </div>
                            <a class="over-link" href="#"></a>
                        ...
                        <div class="rn-service">
                            <div class="inner">
                                ...
                                <div class="content">
                                    ...
                                    <p class="description"> SEO means Search Engine Optimization and is the process used to optimize a website's technical configuration, content relevance and link popularity so its pages can become easily findable, more relevant and popular towards user search queries, and as a consequence, search engines rank them better.</p>
                                    <a class="read-more-button" href="#"><i class="feather-arrow-right"></i></a>
                                </div>
                            </div>
                            <a class="over-link" href="#"></a>
                    ...
                    <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="500" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-sm-12 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div class="rn-service">
                            <div class="inner">
                                ...
                                <div class="content">
                                    <h4 class="title"><a href="#">MARKETING AND ADVERTISING</a></h4>
                                    <p class="description"> 
                    ...
                    <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="500" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-sm-12 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div class="rn-service">
                            <div class="inner">
                                ...
                                <div class="content">
                                    <h4 class="title"><a href="#">SOCIAL MEDIA & CONTENT MANAGEMENT</a></h4>
                                    <p class="description"> 
                                        Social media management is the ongoing process of creating and scheduling content designed to grow and nurture an audience across social media platforms.</p>
                                    <a class="read-more-button" href="#"><i class="feather-arrow-right"></i></a>
                                </div>
                            </div>
                            <a class="over-link" href="#"></a>
                     ...
                     <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="500" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-sm-12 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div class="rn-service">
                            <div class="inner">
                                ...
                                <div class="content">
                                    <h4 class="title"><a href="#">PROJECT MAINTANANCE & UPDATE</a></h4>
                                    <p class="description"> 
                                        Software maintenance is the process of changing, modifying, and updating software to keep up with customer needs. Software maintenance is done after the product has launched for several reasons including improving the software overall, correcting issues or bugs, to boost performance, and more.</p>
                                    <a class="read-more-button" href="#"><i class="feather-arrow-right"></i></a>
                                </div>
                            </div>
                            <a class="over-link" href="#"></a>
                     ...
                     <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="500" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-sm-12 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div class="rn-service">
                            <div class="inner">
                                ...
                                <div class="content">
                                    <h4 class="title"><a href="#">LOGO & POSTER DESIGNING</a></h4>
                                    <p class="description"> 
                                        LOGO : Create a simple, memorable logo that is easy to recognize, Ensure your logo reflects your brand or message, Design a logo that works well across different mediums and sizes,
                                <br><br>  POSTER : Make your poster easy to read and understand at a glance,Use design elements to guide the viewer's attention,Include compelling visuals and a clear call to action.</p>
                                  <a class="read-more-button" href="#"><i class="feather-arrow-right"></i></a>
                                </div>
                            </div>
                            <a class="over-link" href="#"></a>
                        ...
                        <div class="rn-service">
                            <div class="inner">
                                ...
                                <div class="content">
                                    ...
                                    <p class="description"> Chatbots can provide assistance around the clock, ensuring that users can get help or information at any time, which is especially valuable for businesses.</p>
                                    <a class="read-more-button" href="#"><i class="feather-arrow-right"></i></a>
                                </div>
                            </div>
                            <a class="over-link" href="#"></a>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title text-center">
                            <span class="subtitle">Visit our portfolio and keep your feedback</span>
                    ...
                    <div class="col-lg-5">
                        <div class="contact-about-area">
                            ...
                            <!-- <div class="title-area">
                                <h4 class="title">BENO.D.R</h4>
                                <span>CEO</span>
                            </div> -->
                            <div class="description">
                                <p>For Queries Contact Via WHATSAPP our team will contact you instantly
                                </p>
                                <span class="phone">WHATSAPP: <a target="_blank" href="https://wa.me/916379387026">+916379387026</a></span>
                                <span class="mail">Email: <a href="mailto:support@futureinterstellar.com">support@futureinterstellar.com</a></span>
                            </div>
                            <div class="social-area">
                                <div class="name">FIND WITH ME</div>
                                <div class="social-icone">
                                    <a target="_blank" href="#"><img src="assets/images/whatsapp.png" alt="whatsapp" style="height:30px"></a>
                                    <!-- <a href="#"><i data-feather="linkedin"></i></a> -->
                                    <a target="_blank" href="https://instagram.com/futureinterstellar?utm_source=qr&igshid=MThlNWY1MzQwNA"><i data-feather="instagram"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="contact-form-wrapper">
                            <div class="introduce">
                                ...
                                <form class="rnt-contact-form rwt-dynamic-form row" id="contact-form" >
                                    ...
                                    <div class="col-lg-12">
                                        <button name="submit" type="button" id="submit" class="rn-btn">
        ...
        <script>
            $(document).ready(function () {
                $('#submit').click(function () {
                    ...
                    var whatsappLink = 'https://api.whatsapp.com/send?phone=916379387026&text=' + whatsappMessage;
                    // Replace PHONE_NUMBER with the recipient's WhatsApp number
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="footer-area text-center">
                        ...
                        <p class="description mt--30">© 2023. All rights reserved by <a target="_blank" href="/">FUTUREINTERSTELLAR</a></p>
                    </div>
                </div>
            </div>
        </div>
